...
int main() {
    ...
    const char * sql_prepare = "SELECT * FROM temp WHERE a = ?"; // ? is a placeholder or a bind variable
    ...
    sqlite3_bind_text(stmt, 1, param1, -1, SQLITE_STATIC); // this where we bind the string to the statement
